  ...
  <view class="container">
      ...
      <view class="tui-header-icon" :style="{ marginTop: top + 'px' }">
        ...
        >
          <tui-icon
            name="arrowleft"
            :size="30"
            :color="opcity >= 1 ? '#000' : '#fff'"
          ></tui-icon>
        </view>

        <view
          class="tui-icon-box tui-icon-ml"
          :style="{ backgroundColor: 'rgba(0, 0, 0,' + iconOpcity + ')' }"
          @tap.stop="openMenu"
        >
          <tui-icon
            ...
            :color="opcity >= 1 ? '#000' : '#fff'"
          ></tui-icon>
          <tui-badge type="red" :scaleRatio="0.8" absolute top="0" right="-4rpx"
            >5</tui-badge
          >
        </view>
      </view>
    ...
    <view class="tui-banner-swiper">
      ...
      <view class="tui-video__box" @tap.stop="play">
        <image
          src="https://www.thorui.cn/images/mall/img_video_3x.png"
          mode="widthFix"
        ></image>
        <view>00′30″</view>
      </view>
      <view class="tui-banner-tag">
        <tui-tag
          ...
          :scaleMultiple="0.82"
          originRight
          >{{ bannerIndex + 1 }}/{{ banner.length }}</tui-tag
        >
      </view>
    </view>
    ...
    <view class="tui-pro-detail">
      <view class="tui-product-title tui-border-radius">
        <view class="tui-pro-pricebox tui-padding">
          ...
          <view class="tui-collection tui-size" @tap="collecting">
            <tui-icon
              :name="collected ? 'like-fill' : 'like'"
              :color="collected ? '#ff201f' : '#333'"
              :size="20"
            ></tui-icon>
            <view
              class="tui-scale-collection"
              :class="{ 'tui-icon-red': collected }"
              >收藏</view
            >
          </view>
        </view>
        ...
        <view class="tui-pro-titbox">
          <view class="tui-pro-title"
            >谈判官明星同款耳坠韩国气质简约显脸瘦的耳环女百搭个性长款耳钉
            个性水滴耳环【A2】</view
          >
        ...
        <view class="tui-padding">
          <view class="tui-sub-title tui-size tui-gray"
            >此商品将于2019-06-28,10点结束闪购特卖，时尚美饰联合专场</view
          >
        ...
        <view class="tui-list-cell" @tap="showPopup">
          ...
          <view class="tui-addr-box">
            ...
            <view class="tui-addr-item"
              >今日23:59前完成下单，预计6月28日23:30前发货，7月1日24:00前送达</view
            >
          </view>
          <view class="tui-right">
            <tui-icon name="more-fill" :size="20" color="#666"></tui-icon>
      ...
      <view class="tui-product-img tui-radius-all">
        <image
          :src="'https://www.thorui.cn/img/detail/' + (index + 1) + '.jpg'"
          v-for="(img, index) in 20"
          :key="index"
          mode="widthFix"
        ></image>
      </view>
    ...
    <tui-bottom-popup :show="popupShow" @close="hidePopup">
      <view class="tui-popup-box">
        <view class="tui-product-box tui-padding">
          <image
            src="https://www.thorui.cn/img/product/11.jpg"
            class="tui-popup-img"
          ></image>
    ...
    >
      <view class="tui-poster__box" :style="{ marginTop: height + 'px' }">
        <image
          src="/static/images/mall/icon_popup_closed.png"
...
export default {
  ...
  methods: {
    ...
    async createPoster() {
      ...
      let mainPic = await poster.getImage(
        "https://www.thorui.cn/img/product/poster.jpg"
      );
      let qrcode = await poster.getImage(
        "https://thorui.cn/extend/share/applets.png"
      );
      // #ifdef MP-WEIXIN
