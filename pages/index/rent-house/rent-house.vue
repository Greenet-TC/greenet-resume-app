  ...
  <view class="container">
    ...
    <checkbox-group @change="buyChange">
      ...
      >
        ...
        >
          <template v-slot:content>
            <view class="tui-goods-item">
              ...
              <image
                :src="
                  '/static/images/mall/product/' +
                  (index % 2 == 0 ? '1.jpg' : '4.jpg')
                "
                class="tui-goods-img"
              />
        ...
        <view class="tui-sub-info" v-if="index % 2 == 0"
          >赠品：柔色尽情丝柔口红唇膏1支柔色尽情丝柔口红唇膏1支</view
        >
      </view>
    </checkbox-group>
    ...
    <view class="tui-cart-cell tui-mtop">
      ...
      <view
        :class="{ 'tui-invalid-ptop': index !== 0 }"
        ...
        <tui-swipe-action :actions="actions2">
          <template v-slot:content>
            <view class="tui-goods-item">
              ...
              <image
                src="/static/images/mall/product/4.jpg"
                class="tui-goods-img opcity"
              />
              <view class="tui-goods-info">
...
.tui-checkbox .uni-checkbox-input::v-deep {
  width: 40rpx;
  height: 40rpx;
  margin-right: 0 !important;
  border-radius: 50% !important;
...
.tui-checkbox .uni-checkbox-input.uni-checkbox-input-checked::v-deep {
  background: #eb0909;
